...
- (void)enableSessionForAnalyticsValue:(NSNumber *)value error:(FlutterError *_Nullable *_Nonnull)error;
- (void)enableSessionForRecordingValue:(NSNumber *)value error:(FlutterError *_Nullable *_Nonnull)error;
- (void)setRetentionValue:(NSNumber *)value error:(FlutterError *_Nullable *_Nonnull)error;
