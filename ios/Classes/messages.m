...
void FLTMedalliaDxaNativeApiSetup(id<FlutterBinaryMessenger> binaryMessenger, NSObject<FLTMedalliaDxaNativeApi> *api) {
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.MedalliaDxaNativeApi.enableSessionForAnalytics"
        binaryMessenger:binaryMessenger
        codec:FLTMedalliaDxaNativeApiGetCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(enableSessionForAnalyticsValue:error:)], @"FLTMedalliaDxaNativeApi api (%@) doesn't respond to @selector(enableSessionForAnalyticsValue:error:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray *args = message;
        NSNumber *arg_value = GetNullableObjectAtIndex(args, 0);
        FlutterError *error;
        [api enableSessionForAnalyticsValue:arg_value error:&error];
        callback(wrapResult(nil, error));
      }];
    } else {
      [channel setMessageHandler:nil];
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.MedalliaDxaNativeApi.enableSessionForRecording"
        binaryMessenger:binaryMessenger
        codec:FLTMedalliaDxaNativeApiGetCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(enableSessionForRecordingValue:error:)], @"FLTMedalliaDxaNativeApi api (%@) doesn't respond to @selector(enableSessionForRecordingValue:error:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray *args = message;
        NSNumber *arg_value = GetNullableObjectAtIndex(args, 0);
        FlutterError *error;
        [api enableSessionForRecordingValue:arg_value error:&error];
        callback(wrapResult(nil, error));
      }];
    } else {
      [channel setMessageHandler:nil];
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.MedalliaDxaNativeApi.setRetention"
        binaryMessenger:binaryMessenger
        codec:FLTMedalliaDxaNativeApiGetCodec()];
    if (api) {
