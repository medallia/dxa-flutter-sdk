...
+ (FLTLiveConfigurationPigeon *)fromList:(NSArray *)list {
  ...
  pigeonResult.maxScreenshots = GetNullableObjectAtIndex(list, 8);
  pigeonResult.maxScreenDuration = GetNullableObjectAtIndex(list, 9);
  pigeonResult.disableScreenTracking = GetNullableObjectAtIndex(list, 10);
  pigeonResult.screensMasking = GetNullableObjectAtIndex(list, 11);
  pigeonResult.appVersion = GetNullableObjectAtIndex(list, 12);
  return pigeonResult;
}
+ (nullable FLTLiveConfigurationPigeon *)nullableFromList:(NSArray *)list {
