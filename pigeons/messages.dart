...
@ConfigurePigeon(
  PigeonOptions(
    ...
    // Hack to avoid linter warnings, cannot exclude this file from
    // analysis_options.yaml because it is used in the obfuscator
    dartOptions: DartOptions(copyrightHeader: ['ignore_for_file: type=lint']),
